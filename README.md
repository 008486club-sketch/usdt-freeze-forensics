...
| **② 是哪笔交易触发的？** 冻结前流水几十笔，不知道哪笔是"雷" | **冻结关联分析（非因果判断）**：① 冻结前 72h 全量逐笔列出（只陈述链上事实）→ ② 上游/下游资金对手方排名 → ③ 同批冻结地址交集分析。案例：冻结前 38 小时曾入账一笔大额 USDT（来源 TTu3mqj），但**该来源未被官方冻结，目前只能证明资金关系，不能证明冻结因果**——时间邻近 ≠ 因果 |
...
4. **证据分级 [E0-E4]**：结论必须标注证据等级（E0推测 / E1链上事实 / E2强关联 / E3高度支持 / E4官方确认）
5. **占比法验证因果**：金额占比决定资金关系强度（主要资金对手方，非"供血方"）
6. **时间邻近 ≠ 因果**：冻结前大额入账 ≠ 冻结原因。案例 TTu3mqj 未被官方冻结 → 只能证明资金关系，不能证明冻结因果
