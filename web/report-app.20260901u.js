...
zh: {
  ...
  txTitle:"关键交易记录",txTime:"时间",txDir:"方向",txAmt:"金额 (USDT)",txCp:"对手方",txHash:"TxHash",txFull:"🔗 在 TronScan 查看完整交易记录（官方）",copyBtn:"复制",
...
vi: {
  ...
  txTitle:"Giao dịch quan trọng",txTime:"Thời gian",txDir:"Hướng",txAmt:"Số tiền (USDT)",txCp:"Đối tác",txHash:"TxHash",txFull:"🔗 Xem toàn bộ giao dịch trên TronScan (chính thức)",copyBtn:"Sao chép",
...
en: {
  ...
  txTitle:"Key Transactions",txTime:"Time",txDir:"Direction",txAmt:"Amount (USDT)",txCp:"Counterparty",txHash:"TxHash",txFull:"🔗 View full transaction history on TronScan (official)",copyBtn:"Copy",
