...
zh: {
  ...
  txTitle:"关键交易记录",txTime:"时间",txDir:"方向",txAmt:"金额 (USDT)",txCp:"对手方",txHash:"TxHash",txFull:"🔗 在 TronScan 查看完整交易记录（官方）",copyBtn:"复制",shareBtn:"分享报告",shareOk:"报告链接已复制，发给朋友即可打开查看",shareText:"USDT 冻结检测报告",
...
vi: {
  ...
  txTitle:"Giao dịch quan trọng",txTime:"Thời gian",txDir:"Hướng",txAmt:"Số tiền (USDT)",txCp:"Đối tác",txHash:"TxHash",txFull:"🔗 Xem toàn bộ giao dịch trên TronScan (chính thức)",copyBtn:"Sao chép",shareBtn:"Chia sẻ báo cáo",shareOk:"Đã sao chép liên kết báo cáo",shareText:"Báo cáo kiểm tra đóng băng USDT",
...
en: {
  ...
  txTitle:"Key Transactions",txTime:"Time",txDir:"Direction",txAmt:"Amount (USDT)",txCp:"Counterparty",txHash:"TxHash",txFull:"🔗 View full transaction history on TronScan (official)",copyBtn:"Copy",shareBtn:"Share report",shareOk:"Report link copied",shareText:"USDT Freeze Check Report",
